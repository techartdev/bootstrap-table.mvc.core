...
{
    /// <exclude/>
    public interface ITableApply<TResult> : IHtmlContent
    {
        /// <summary>
    ...
    /// <exclude/>
    public interface IColumnApply<TResult> : IHtmlContent
    {
        /// <summary>
    ...
    /// </summary>
    public interface ITableBuilder : ITableApply<ITableBuilder>, IHtmlContent
    {
        /// <summary>
    ...
    /// Implementation to support bootstrap-table.
    /// </summary>
    public interface IColumnBuilder : ITableBuilder, IColumnApply<IColumnBuilder>, IHtmlContent
    {
        /// <summary>
        /// Apply an option to a column.
        /// </summary>
